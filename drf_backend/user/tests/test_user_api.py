...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_bad_credentials(self):
        ...
        create_user(email='test4@example.com', password='goodPassword')

        payload = {'email': 'test4@example.com', 'password': 'wrongPassword'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_email_not_found(self):
        ...
        payload = {'email': 'test5@example.com', 'password': 'pass123'}
        res = self.client.post(TOKEN_URL, payload)
